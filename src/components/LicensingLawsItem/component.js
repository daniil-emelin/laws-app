...
export default class LicensinglawsItem extends React.PureComponent {
    render() {
        return (
            <Link onPress={this.props.onPress} style={{ backgroundColor: 'white' }} to={this.props.to} underlayColor='white'>
